...
5. now install libraries
            pip install flask streamlit pandas scikit-learn numpy joblib imbalanced-learn matplotlib
  
8.(any other if propmted then install it later)
9. to run in terminal use
       python modelname.py

10. to start backend 
        cd .. (to move one folder back)

11. go to backend_api folder and type 
